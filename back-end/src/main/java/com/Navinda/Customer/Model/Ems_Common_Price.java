...
@Entity
@Table(name="Ems_Common_Price")
public class Ems_Common_Price {
	...
	public int getFrist250gPrice() {
		return frist250gPrice;
	}

	public void setFrist250gPrice(int frist250gPrice) {
		this.frist250gPrice = frist250gPrice;
	}
