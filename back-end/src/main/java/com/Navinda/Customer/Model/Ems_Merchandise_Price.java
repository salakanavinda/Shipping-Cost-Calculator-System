...
@Entity
@Table(name="Ems_Merchandise_Price")
public class Ems_Merchandise_Price {
	...
	private int initialmerchantdisePrice;
	...
	public int getInitialmerchantdisePrice() {
		return initialmerchantdisePrice;
	}

	public void setInitialmerchantdisePrice(int initialmerchantdisePrice) {
		this.initialmerchantdisePrice = initialmerchantdisePrice;
	}
